<template>
  <div style="background-color: rgb(240, 240, 240)">
    <el-drawer title="请输入新增信息" v-model="dialog" direction="ltr" custom-class="demo-drawer" ref="drawer"
      ...
      <div class="demo-drawer__content">
        <el-form :model="form" ref="form">
          ...
          <el-form-item label="身份" :label-width="formLabelWidth" prop="role" :rules="[
          ...
          <el-form-item label="状态" :label-width="formLabelWidth" prop="status" :rules="[
    ...
    <div>
      <el-breadcrumb separator-class="el-icon-d-arrow-right">
        <el-breadcrumb-item :to="{ path: '/home' }">回到首页
        </el-breadcrumb-item>
        <el-breadcrumb-item :to="{ path: '/admin1' }">用户管理
        </el-breadcrumb-item>
      </el-breadcrumb>
    </div>
    <div style="padding: 15px">
      ...
      <div style="margin: 10px 0">
        <el-pagination @size-change="handleSizeChange" @current-change="handleCurrentChange" :current-page="currentPage"
          :page-sizes="[5, 10, 20, 50, 250]" :page-size="pageSize" layout="total, sizes, prev, pager, next, jumper"
          :total="total">
        </el-pagination>
      </div>
      <div style="margin: 10px 0">
